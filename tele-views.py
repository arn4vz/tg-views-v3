...
def tui():
  ...
  LINK : {channel.capitalize()}/{post}
  {F} Live Views : {real_views}
...
except: print(' Error | Channel Or Post Not Found!');sleep(3);exit()
else:
    print(' Stated | Wait few seconds to run threads')
